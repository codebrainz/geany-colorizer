...
namespace Geany {
	...
	*/
	[CCode (cname = "_ScintillaObject", cprefix = "sci_")]
	public class Sci : Scintilla.Object {
		...
		{
			return (int)this.send_message (Scintilla.Messages.GETEOLMODE);
		}
		...
		public int get_eol_char_len ()
		{
			...
			{
				case Scintilla.EolTypes.CRLF:	return 2;
				default:			return 1;
			}
		}
	}
